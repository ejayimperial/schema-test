angular.module('schemaForm').config(['schemaFormDecoratorsProvider',function(decoratorsProvider){
  var base = 'web/app/scripts/directives/decorators/bootstrap/';
  decoratorsProvider.createDecorator('bootstrapDecorator',{
    ...
    timepicker: base+'timepicker.html',
    datetimepicker: base+'datetimepicker.html', 
    switcher: base+'switcher.html', 
    select2: base+'select2.html',  
    input_select: base+'input_select.html', 
